    ...
    <section className="relative overflow-hidden py-10 sm:py-16 bg-white">
      <div className="container relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-[32px] border border-blue-100 bg-[#F0F6FF] p-8 sm:rounded-[36px] sm:p-12 md:p-14 text-center">
          {/* Subtle Glow */}
          <div className="pointer-events-none absolute -right-20 -top-20 hidden h-64 w-64 rounded-full bg-[#1D4ED8]/10 blur-[80px] md:block" />
          ...
          <div className="relative z-10 mx-auto flex max-w-3xl flex-col items-center">
            ...
            <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
              <Link
                href="/lien-he/"
                className="flex h-14 w-full items-center justify-center gap-2 rounded-full bg-[#1D4ED8] px-8 text-[15px] font-bold text-white transition-all hover:scale-105 hover:bg-blue-600 hover:shadow-lg hover:shadow-blue-500/25 sm:w-auto"
              >
                Nhận tư vấn miễn phí <ArrowRight size={18} />
              </Link>
              <Link
                href="/bao-gia-seo/"
                className="group flex h-14 w-full items-center justify-center gap-2 rounded-full border border-slate-200 bg-white px-8 text-[15px] font-bold text-[#04091A] transition-all hover:border-[#1D4ED8] hover:text-[#1D4ED8] sm:w-auto"
              >
                Xem báo giá SEO
