...
export function ConsultingCta() {
  return (
    <section className="bg-[#04091A] py-16 lg:py-24 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-[#3BA6F1]/20 via-[#04091A]/0 to-transparent"></div>
      
      <div className="container relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="mb-6 text-[40px] font-black leading-[1.15] tracking-tight text-white md:text-[56px] text-balance">
          Sẵn sàng định vị lại <span className="text-[#3BA6F1]">thương hiệu số</span> của bạn?
        </h2>
        <p className="mx-auto mb-10 max-w-2xl text-[17px] font-medium leading-[1.7] text-slate-300 text-pretty">
