              ...
              {hubs.map((hub, index) => {
                ...
                return (
                  <RevealOnScroll key={hub.title} delay={index * 60} direction="up">
                    <Link href={`/seo/${hub.slug}/`} className="group relative overflow-hidden rounded-3xl border border-slate-200 bg-white p-4 shadow-sm transition hover:-translate-y-1 hover:border-blue-200 hover:shadow-xl">
