...
import { Search } from 'lucide-react'; // Replaced hardcoded SVG with lucide-react
...
const AnimatedLoadingSkeleton = () => {
    ...
    useEffect(() => {
        if (windowWidth === 0) return; // Prevent initial flash
    ...
    const config = getGridConfig(windowWidth || 1024); // Fallback to desktop layout on first render
