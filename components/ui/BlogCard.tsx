  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col justify-between p-6 sm:p-7">
        <div>
          <time className="text-[11px] font-black uppercase tracking-widest text-[#3BA6F1]">
          ...
          <h2 className="mt-3 text-[18px] font-bold tracking-tight text-[#04091A] transition-colors duration-300 group-hover:text-[#3BA6F1] line-clamp-3 text-balance leading-[1.4]">
            {post.title}
          </h2>
        </div>
        <div className="mt-6 flex items-center gap-2">
          <div className="rounded-[12px] bg-[#F8FAFC] px-4 py-2 text-[13px] font-bold text-slate-600 transition-colors group-hover:bg-[#3BA6F1]/10 group-hover:text-[#3BA6F1]">
            Đọc tiếp
          </div>
        </div>
      </div>
